                        ...
                        <nav class="menuzord js-primary-navigation menuzord-responsive" role="navigation" aria-label="Primary Navigation">
                            ...
                            <div class="outer-header visible-md-block visible-lg-block ">
                                <div class="social-links text-normal">
                                    ...
                                    <br>
                                    <span class="fa fa-envelope span-fa"></span> sethuksethu@gmail.com
                                    <br>
                                    <span class="fa fa-mobile span-fa"></span> 9747542756
                                </div>
                            ...
                            <ul class="menuzord-menu menuzord-right c-nav_s-standard menuzord-indented scrollable" style="max-height: 400px;">
                                ...
                                <li class="">
                                    <a href="rules_bylaws">Rules and Bylaws</a>
                                </li>
                                <li class="">
                                    <a href="administration">Administration</a>
                                </li>
                                <li class="">
                                    <a href="sessions">Session Held</a>
                                </li>
                                <li class="">
